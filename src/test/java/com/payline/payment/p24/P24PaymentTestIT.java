...
public class P24PaymentTestIT extends AbstractPaymentTest {
    ...
    public void fullPaymentTest() {
        ...
        ConfigurationServiceImpl.checkHttpConnection(p24CheckConnectionRequest, errors);
        ...
        ConfigurationServiceImpl.checkSoapConnection(p24TestAccessRequest, errors);
        Assert.assertTrue(errors.isEmpty());
    ...
    public PaymentRequest createDefaultPaymentRequest() {
        amount = new Amount(BigInteger.TEN, Currency.getInstance("PLN"));
